...
public class SwaggerConfig {
	...
	public static ApiInfo metadata() {
		...
		.title("O caminho para se tornar dev Jr")
		.description("As conquistas e reflexoes de alguém no caminho para se tornar dev.Jr")
		.version("1.0.0")
		.license("Apache License Version 2.0")
		.licenseUrl("https://github.com/lefesi")
		.contact(contact())
		.build();
	}
	
		private static Contact contact() {
			return new Contact("Letícia Ferreira da Silva",
			"https://github.com/lefesi",
			"silvafeleticia@gmail.com");	
		}
